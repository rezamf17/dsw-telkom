...
<section class="section">
              ...
              <tbody>
                <tr>
                  ...
                  <td style="width: 180px;">
                    <div class="col-xs-1">
                    <input type="text" name="witel[]" class="form-control input-sm" placeholder="Witel" />
                    </div>
                  </td>
                  <td style="width: 120px;">
                    <input type="text" name="tgtmtd[]" placeholder="0" class="form-control"/>
                  </td>
                  <td style="width: 120px;">
                    <input type="text" name="realmtd[]" placeholder="0" class="form-control"/>
                  </td>
                  <td style="width: 120px;">
  ...
  <script type="text/javascript">
    ...
    $("#dynamic-ar").click(function () {
      ++i;
      ++j;
      var witel = '<td><input type="text" name="witel[]" class="form-control" placeholder="Witel"/></td>'
      var tgtmtd = '<td><input type="text" name="tgtmtd[]" class="form-control" placeholder="0"/></td>'
      var realmtd = '<td><input type="text" name="realmtd[]" class="form-control" placeholder="0"/></td>'
      var tgtrev = '<td><input type="text" name="tgtrev[]" class="form-control" placeholder="0"/></td>'
      var progrev = '<td><input type="text" name="progrev[]" class="form-control" placeholder="0"/></td>'
